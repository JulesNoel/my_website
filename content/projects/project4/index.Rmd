...
ggsave("graph1_challenge1.jpg",plot=graph1_challenge1,width = 10,height = 8, dpi = 200)

# And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph1_challenge1.jpg"))
```
...
# This line saves the graph as a .jpg file
ggsave("graph2_challenge1.jpg",width = 15,height = 10, dpi = 150)

# And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph2_challenge1.jpg"))
```
...
# This line saves the graph as a .jpg file
ggsave("graph3_challenge1.jpg",width = 10,height = 8, dpi = 150)

# And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph3_challenge1.jpg"))
```
...
# This line saves the graph as a .jpg file
ggsave("graph_1.jpg",plot=graph_1,width = 8,height = 5,dpi=200)


# # And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph_1.jpg"))
...
GDPplot <- ggplot(data = GDP_indicators, 
 ...
 # This line saves the graph as a .jpg file
ggsave("graph_c2.jpg",width = 10,height = 6,dpi=200)


# # And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph_c2.jpg"))
...
task2plot <- ggplot(
  ...
  # This line saves the graph as a .jpg file
ggsave("graph_c2_3.jpg",plot=task2plot,width = 10,height = 6,dpi=200)


# # And this line includes the above mentioned picture in the HTML knited file
knitr::include_graphics(here::here("graph_c2_3.jpg"))
